...
const INFOGRAPHICS_COPY = {
  ...
  ca: [
    "Les infografies i les visualitzacions de dades tenen un paper central en la recerca i la comunicació arqueològiques, ja que transformen conjunts de dades complexos, relacions espacials, seqüències cronològiques i resultats analítics en relats visuals clars i estructurats. Permeten sintetitzar grans volums d’informació, revelar patrons que poden ser difícils d’identificar en les dades en brut i posar en relleu dinàmiques temporals, espacials, quantitatives o relacionals d’una manera immediata i accessible.",
    "Més enllà de presentar resultats, aquestes eines visuals poden donar suport actiu al procés de recerca. En organitzar la informació mitjançant diagrames, mapes, línies de temps, gràfics comparatius i altres sistemes visuals, faciliten l’anàlisi, afavoreixen la interpretació i ajuden els investigadors a explorar les relacions entre diferents tipus d’evidència arqueològica. El seu disseny requereix, per tant, un equilibri acurat entre precisió científica, jerarquia de la informació i claredat visual.",
    "En combinar un tractament rigorós de les dades amb un disseny gràfic atent, les infografies i les visualitzacions de dades poden comunicar coneixement arqueològic complex sense simplificar-lo en excés. Proporcionen eines eficaces per a publicacions acadèmiques, exposicions, plataformes digitals, recursos educatius i divulgació pública, adaptant el contingut científic a diferents contextos i públics. D’aquesta manera, la comunicació visual esdevé una part integral de la producció, la interpretació i la difusió del coneixement arqueològic.",
  ],
  es: [
    "Las infografías y las visualizaciones de datos desempeñan un papel central en la investigación y la comunicación arqueológicas al transformar conjuntos de datos complejos, relaciones espaciales, secuencias cronológicas y resultados analíticos en narrativas visuales claras y estructuradas. Permiten sintetizar grandes volúmenes de información, revelar patrones que pueden resultar difíciles de identificar en los datos en bruto y destacar dinámicas temporales, espaciales, cuantitativas o relacionales de forma inmediata y accesible.",
    "Más allá de su papel en la presentación de resultados, estas herramientas visuales pueden apoyar activamente el propio proceso de investigación. Al organizar la información mediante diagramas, mapas, cronologías, gráficos comparativos y otros sistemas visuales, facilitan el análisis, fomentan la interpretación y ayudan a los investigadores a explorar las relaciones entre distintos tipos de evidencia arqueológica. Por ello, su diseño requiere un cuidadoso equilibrio entre precisión científica, jerarquía de la información y claridad visual.",
    "Al combinar un manejo riguroso de los datos con un diseño gráfico reflexivo, las infografías y las visualizaciones de datos pueden comunicar conocimientos arqueológicos complejos sin simplificarlos en exceso. Constituyen herramientas eficaces para publicaciones académicas, exposiciones, plataformas digitales, recursos educativos y divulgación pública, adaptando el contenido científico a distintos contextos y públicos. De este modo, la comunicación visual se convierte en una parte integral de la producción, la interpretación y la difusión del conocimiento arqueológico.",
  ],
  fr: [
    "Les infographies et les visualisations de données jouent un rôle central dans la recherche et la communication archéologiques en transformant des jeux de données complexes, des relations spatiales, des séquences chronologiques et des résultats analytiques en récits visuels clairs et structurés. Elles permettent de synthétiser de grands volumes d’informations, de révéler des tendances parfois difficiles à identifier dans les données brutes et de mettre en évidence, de manière immédiate et accessible, des dynamiques temporelles, spatiales, quantitatives ou relationnelles.",
    "Au-delà de leur rôle dans la présentation des résultats, ces outils visuels peuvent soutenir activement le processus de recherche lui-même. En organisant l’information au moyen de schémas, de cartes, de frises chronologiques, de graphiques comparatifs et d’autres systèmes visuels, ils facilitent l’analyse, encouragent l’interprétation et aident les chercheurs à explorer les relations entre différents types de données archéologiques. Leur conception exige donc un équilibre attentif entre précision scientifique, hiérarchisation de l’information et clarté visuelle.",
    "En associant une gestion rigoureuse des données à une conception graphique réfléchie, les infographies et les visualisations de données peuvent communiquer des connaissances archéologiques complexes sans les simplifier à l’excès. Elles constituent des outils efficaces pour les publications universitaires, les expositions, les plateformes numériques, les ressources pédagogiques et la médiation auprès du public, en adaptant le contenu scientifique à différents contextes et publics. La communication visuelle devient ainsi partie intégrante de la production, de l’interprétation et de la diffusion des connaissances archéologiques.",
  ],
};

const COMMON_TRANSLATIONS = {
  en: {
    nav: ["Infographics", "3D", "Branding", "Photography", "Print", "Contact"],
  ...
  ca: {
    nav: ["Infografia", "3D", "Branding", "Fotografia", "Impressió", "Contacte"],
  ...
  es: {
    nav: ["Infografía", "3D", "Branding", "Fotografía", "Impresión", "Contacto"],
  ...
  fr: {
    nav: ["Infographie", "3D", "Branding", "Photographie", "Impression", "Contact"],
...
function translatePage(language) {
  ...
  if (getPageKey() === "index") {
    ...
    const categoryParagraphs = getPageKey() === "infographics" ? INFOGRAPHICS_COPY[language] : page.paragraphs;
    document.querySelectorAll(".category-work-content p").forEach((paragraph, index) => {
      if (categoryParagraphs?.[index]) paragraph.textContent = categoryParagraphs[index];
    });
    if (getPageKey() !== "infographics" || language === "en") {
